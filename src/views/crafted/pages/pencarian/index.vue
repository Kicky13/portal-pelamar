        ...
        <div
          ...
          <div class="informasi-banner">
            ...
            <div class="total-lowongan">
              <strong>{{ lowonganModule.listLowongan.length }}</strong> Lowongan
              Tersedia
            </div>
          </div>
          ...
          <div class="form-pencarian">
            <div class="row d-flex justify-content-center">
              ...
              <div class="col-sm-2">
                <button @click="cari" class="btn btn-primary-portal w-100">
                  Cari
                </button>
              </div>
            </div>
      ...
      <div class="col-sm-12">
        <div class="container">
          <div class="pencarian-content">
            <div class="title">
              Menampilkan <strong>{{ endIndex + 1 }}</strong> dari
          ...
          <div class="pencarian-list">
            ...
            <div v-if="showData.length === 0" class="empty-state-lowongan">
              ...
              <div class="sub-title">
                Mari coba cari ulang lowongan yang kamu cari
              </div>
            </div>
            <!--  -->
          </div>
          <div class="pagination-portal">
            <nav aria-label="Page navigation example">
              <ul class="pagination">
                <li
                  :class="startIndex == 0 ? `page-item disabled` : `page-item`">
                  <a class="page-link page-link-prev" href="#">Prev</a>
                </li>
                <li
                  v-for="item in pagination"
                  :class="
                    item == activePageIndex ? classActive : classInactive
                  ">
                  <button
                    v-if="item == activePageIndex"
                    disabled
                    class="page-link">
                    {{ item }}
                  </button>
  ...
  methods: {
    ...
    setupPagination() {
      ...
      if (this.totalItems <= this.itemPerPage) {
        ...
        this.showData = this.lowonganModule.listLowongan.slice(
          this.startIndex,
          this.endIndex
        );
